const { isWord, makeDictionary, makeAnagramer, removeLetter, removeLetter2 } = require('../word_graph');
const dick = {'word': []};
...
describe('removeLetter2',()=>{
  it('should be a function', ()=>{
    expect(typeof removeLetter2).toBe('function');
  });
  describe('should return correct values', ()=>{
    it('should return [] for "a"', ()=>{
      let input = "a";
      let output = [];
      let actual = removeLetter2(input);
      expect(actual).toEqual(output);
    });
    it('should return ["a"] for "aa"', ()=>{
      let input = "aa";
    ...
    it('should return ["a","b"] for "ab"', ()=>{
      let input = "ab";
      let output = ["a","b"].sort();
      let actual = removeLetter2(input).sort();
      expect(actual).toEqual(output);
    });
    it('should return ["at","ca","ct"] for "cat"', ()=>{
      let input = "cat";
